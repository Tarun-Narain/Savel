...
public class CPanel extends JPanel{
            ...
            public void run() {
              //  System.out.println("TimerTask executing counter is: " + i);
                ...
                try {
					...
					Cost.setText(Float.toString((i*Float.parseFloat(Product.get(2))*3)/360000));
					float lb=i*Float.parseFloat(Cost.getText())*3/360000;
					float sb = 0;
					if(!NotificationInfo.getText().toString().isEmpty())
					{
					sb=Float.parseFloat(NotificationInfo.getText());
					//System.out.println(lb+" "+sb);
					if(lb>=sb&&flag2==0)
					{
	...
	JLabel Title =new JLabel("Charger Control And Management");
	...
	}public static ArrayList<String> GetNames()
	{
		...
		try
		{
			FileReader fr=new FileReader("Files/Charger.txt");
			int i;
			String s="";
			while((i=fr.read())!=-1)
			{
	...
	public void Email()
	{
		...
		obj.send("tnarain5@gmail.com", "NICHEbabysotahai", "tnarain5@gmail.com","Alert Electricity Limit Reached" ,"Your Limitations for the Device Fan Has crossed the limits"+ Cost.getText());
