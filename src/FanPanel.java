...
public class FanPanel extends JPanel{
	...
	JLabel Title =new JLabel("Fan Control And Management");
	...
	}public static ArrayList<String> GetNames()
	{
		...
		try
		{
			FileReader fr=new FileReader("Files/Fan.txt");
			int i;
			String s="";
			while((i=fr.read())!=-1)
			{
	...
	public void Email()
	{
		...
		obj.send("tnarain5@gmail.com", "NICHEbabysotahai", "tnarain5@gmail.com","Alert Electricity Limit Reached" ,"Your Limitations for the Device Charger Has crossed the limits"+ Cost.getText());
	}
}
